...
de 23 puntos — no reescribes código (no tienes Write/Edit) y no confías en lo
...
3. Evalúa cada uno de los 23 puntos contra el diff real, citando siempre `archivo:línea`
...
5. Los 23 puntos solo admiten tres estados: `PASS`, `FAIL` o `N/A`. Nunca reclasifiques
...
## Los 23 puntos (mismo orden que `process-definition-of-done`)
...
Esta salida punto por punto (los 23 ítems con su PASS/FAIL/N/A y evidencia) debe
